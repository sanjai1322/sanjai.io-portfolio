    ...
    <section className="py-32 md:py-64">
      ...
      <div className="pt-10 md:pt-16 lg:pt-20">
        <div className="relative mx-auto flex items-center justify-center lg:max-w-5xl">
          ...
          <div className="absolute inset-y-0 left-0 w-12 bg-gradient-to-r from-bg-primary to-transparent z-10"></div>
          <div className="absolute inset-y-0 right-0 w-12 bg-gradient-to-l from-bg-primary to-transparent z-10"></div>
        </div>
      </div>
    </section>
  );
